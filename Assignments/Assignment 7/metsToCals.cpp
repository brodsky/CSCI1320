// 3. One way to measure the amount of energy that is expended during exercise is to use metabolic equivalents (MET).  Here are some METS for various activities:
...
double lbWeight, metEquiv, activeMins; 
...
int main(){
    ...
    cout << "Calories burned while doing the activity for the specified amount of time: "; 
